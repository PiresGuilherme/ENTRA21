...
// const m = substantivos.filter(t => t.toLowerCase(0).charAt(0)==='m').map((n) => n.toLocaleUpperCase());
// console.log(m);
...
//     const medias = nota.notas.reduce((i, a) => i + a, 0) / 2;
...
// let alunosAprovados = media.filter((aluno) => {aluno.medias >= 7;
//    if (aluno.medias >= 7) {
//     console.log(`A média de ${aluno.nome} é ${aluno.medias} e está aprovado`);
//    }  else{
//     console.log(`A média de ${aluno.nome} é ${aluno.medias} e está reprovado`);
//    }
// });
